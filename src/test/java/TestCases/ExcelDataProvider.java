...
public class ExcelDataProvider {
    ...
    public Object[][] excelDP1() throws  RuntimeException,IOException {
        Object[][] arrObj1 = getExcelData (System.getProperty("user.dir")+"/Resources/TestData/ReadItem.xlsx");
         return arrObj1;
          }
    ...
    public void SanpdealTestcases(String searchName) throws InterruptedException, IOException {
        ...
        //Assert.assertFalse(actualString.contains("We've got"));
